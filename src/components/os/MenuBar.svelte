...
>
  {#if !isMobile}
    ...
    <div class="menu-item-wrap" data-menu="apple">
      ...
      >
        <!-- The official Apple logo (apple with the bite), drawn as a path. -->
        <svg width="12" height="16" viewBox="0 0 384 512" fill="currentColor" aria-hidden="true">
  ...
  <!-- Vamsi Krishna Kollipara (direct button) -->
  <button
    class="menu-title owner-btn"
    onclick={() => { onopenpath('/intro'); }}
  >Vamsi Krishna Kollipara</button>
